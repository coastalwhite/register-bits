...
// F > T
pub trait Reg16BitsDownCast<const T: usize>: Reg16BitsBitSize + Copy + Into<BaseType> {
...
pub trait Reg16BitsUpCast<const T: usize>: Reg16BitsBitSize + Copy + Into<BaseType> {
