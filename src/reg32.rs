...
// F > T
pub trait Reg32BitsDownCast<const T: usize>: Reg32BitsBitSize + Copy + Into<BaseType> {
...
pub trait Reg32BitsUpCast<const T: usize>: Reg32BitsBitSize + Copy + Into<BaseType> {
